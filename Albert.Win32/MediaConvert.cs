...
public static class MediaConvert
{
    ...
    /// <summary>
    /// Method clears the Children, Row Deffintions, and Column Definitions of a Grid
    /// </summary>
    /// <param name="_grid"></param>
    public static void ClearAll(this Grid _grid)
    {
    ...
    /// <summary>
    /// Method is used to quickly add children to a Grid
    /// </summary>
    /// <param name="_grid"></param>
    /// <param name="_children"></param>
    public static void AddChildren(this Grid _grid, params UIElement[] _children )
    {
    ...
    /// <summary>
    /// Method is used to quickly add Row Definitions to a Grid
    /// </summary>
    /// <param name="_grid"></param>
    /// <param name="_rows"></param>
    public static void AddRows(this Grid _grid, params RowDefinition[] _rows)
    {
    ...
    /// <summary>
    /// Method is used to quickly add Column Definitions to a Grid
    /// </summary>
    /// <param name="_grid"></param>
    /// <param name="_columns"></param>
    public static void AddColumns(this Grid _grid, params ColumnDefinition[] _columns)
	{
